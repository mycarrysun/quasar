<template>
    <div class="q-uploader" @ondrop.native="__add" @ondragover.native="prevent" @ondragend.native="prevent">
        <q-input-frame
                ref="input"
                class="no-margin"
        ...
        >
            ...
            <q-icon
                    ...
                    slot="after"
                    name="cloud_upload"
                    class="q-if-control upload-btn"
                    :disabled="length === 0"
                    @click="upload"
            ></q-icon>
        </q-input-frame>
        <div class="q-uploader-files scroll">
            <div class="text-center" v-if="multiple || files.length == 0">
                <q-btn v-if="!uploading"
                       slot="after"
                       icon="add"
